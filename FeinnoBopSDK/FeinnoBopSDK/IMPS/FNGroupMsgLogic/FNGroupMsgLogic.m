           ...
           callback:(void (^)(FNSendMsgResponse *))callback
{
    ...
    msgEntity.peerID = textMsgReq.peerID;
    ...
    msgEntity.senderId = textMsgReq.senderId;
    ...
    [[McpRequest sharedInstance] send:cmd userid:sender body:body callback:^(NSData *data) {
        if (data)
        {
            ...
            [FNRecentConversationTable updateSendStatus:success ? MsgSendSuccess : MsgSendFailed syncId:success ? result.syncID : [FNUserTable getSyncId:EventTypePG] msgId:textMsgReq.msgId];
        ...
        else
        {
            ...
            [FNGroupMsgTable updateSendMsgStatus:msgEntity.msgId
                                          syncId:[FNUserTable getSyncId:EventTypePG]
...
//            [[NSNotificationCenter defaultCenter] postNotificationName:@"sendRichTextMsg" object:message];
        ...
        else
        {
            ...
            [FNRecentConversationTable updateSendStatus:MsgSendFailed syncId:[FNUserTable getSyncId:EventTypePG] msgId:richTextMsgReq.msgEntity.msgId];
            //业务层要求
//            message.sendStatus = MsgSendFailed;
//            [[NSNotificationCenter defaultCenter] postNotificationName:@"sendRichTextMsg" object:message];
...
{
    [FNGroupMsgLogic saveRichTextMessage:richTextMsgReq];
            ...
            if (200 == serviceRsp.statusCode)
            {
                ...
                [[McpRequest sharedInstance] send:cmd userid:userid body:body callback:^(NSData *data) {
                    ...
                    else
                    {
                        ...
                        [FNGroupMsgTable updateSendMsgStatus:richTextMsgReq.msgEntity.msgId syncId:[FNUserTable getSyncId:EventTypePG]  sendStatus:MsgSendFailed sendTime:[FNSystemConfig dateToString:[FNSystemConfig getLocalDate]]];
