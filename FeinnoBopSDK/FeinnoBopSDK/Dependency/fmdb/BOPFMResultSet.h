...
@class BOPFMDatabase;
@class BOPFMStatement;

/** Represents the results of executing a query on an `<BOPFMDatabase>`.
...
@interface BOPFMResultSet : NSObject {
    BOPFMDatabase          *_parentDB;
    BOPFMStatement         *_statement;
...
/** `BOPFMStatement` used by result set. */

@property (atomic, retain) BOPFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<BOPFMStatement>`
 
 @param statement A `<BOPFMStatement>` to be performed
 
 @param aDB A `<BOPFMDatabase>` to be used
 
 @return A `BOPFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(BOPFMStatement *)statement usingParentDatabase:(BOPFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(BOPFMDatabase *)newDb;
