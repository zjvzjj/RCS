        ...
        [self getCheckResult:NO
                    ...
                    callback:^(FNFileUploadResponse *rspArgs) {
                        ...
                        else if (200 == rspArgs.statusCode)
                        {
                            ...
                            NSDictionary *dataInfo = [[NSDictionary alloc] initWithObjectsAndKeys:fileInfo.filePath,@"filePath",uploadFileReq.fileType,@"contentType",[NSString stringWithFormat:@"%ld",fileInfo.fileSize],@"fileSize",@"1",@"finishedBlockCount",@"1",@"totalBlockCount",fileInfo.fileName,@"fileName",fileInfo.source,@"tid",nil];
                  ...
                  callback:(void(^)(FNFileUploadResponse *))mtCallback
{
    ...
    NSString *type = uploadFileReq.filePath.pathExtension;
    NSString *sp = uploadFileReq.sp;
               ...
               callback:(void(^)(FNFileUploadResponse *))mtCallback
{
    ...
    if (data && [data length] > 0)
    {
        ...
        BOPAFHTTPRequestOperation *op = [[BOPAFHTTPRequestOperation alloc] initWithRequest:req];
        op.completionQueue = fileUploadQueue;//一个线程？？？
