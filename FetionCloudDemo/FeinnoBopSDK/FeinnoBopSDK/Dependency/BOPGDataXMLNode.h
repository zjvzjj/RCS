...
_EXTERN const char* kBOPGDataXMLXPathDefaultNamespacePrefix _INITIALIZE_AS("_def_ns");
...
enum {
  BOPGDataXMLInvalidKind = 0,
  BOPGDataXMLDocumentKind,
  BOPGDataXMLElementKind,
  BOPGDataXMLAttributeKind,
  BOPGDataXMLNamespaceKind,
  BOPGDataXMLProcessingInstructionKind,
  BOPGDataXMLCommentKind,
  BOPGDataXMLTextKind,
  BOPGDataXMLDTDKind,
  BOPGDataXMLEntityDeclarationKind,
  BOPGDataXMLAttributeDeclarationKind,
  BOPGDataXMLElementDeclarationKind,
  BOPGDataXMLNotationDeclarationKind
};

typedef NSUInteger BOPGDataXMLNodeKind;

@interface BOPGDataXMLNode : NSObject <NSCopying> {
@protected
...
+ (BOPGDataXMLElement *)elementWithName:(NSString *)name URI:(NSString *)value;
...
@interface BOPGDataXMLElement : BOPGDataXMLNode
...
- (BOPGDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
...
@interface BOPGDataXMLDocument : NSObject {
@protected
