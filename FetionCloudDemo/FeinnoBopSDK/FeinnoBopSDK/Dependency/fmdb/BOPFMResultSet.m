...
+ (instancetype)resultSetWithStatement:(BOPFMStatement *)statement usingParentDatabase:(BOPFMDatabase*)aDB {
    ...
    return BOPFMDBReturnAutoreleased(rs);
}
...
- (void)dealloc {
    ...
    BOPFMDBRelease(_columnNameToIndexMap);
...
- (NSDictionary*)resultDict {
    ...
    if (num_cols > 0) {
        ...
        return BOPFMDBReturnAutoreleased([dict copy]);
    }
    else {
