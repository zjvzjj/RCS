...
/** Category of additions for `<BOPFMDatabase>` class.
...
@interface BOPFMDatabase (BOPFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `BOPFMResultSet` of schema; `nil` on error.
