 ...
 *
 */
typedef void (^CLogoutResult)(rcs_state* R,LogoutResult* s);
 ...
 *
 */
typedef void (^CEPManagerSession)(rcs_state* R,EPManagerSession* s);
...
@property (nonatomic,copy) CEPManagerSession endpointListener;
 ...
 *
 */
-(int) gpcreate:(rcs_state*)R resourcelists:(NSString*)resourcelists subject:(NSString*)subject callback:(CGroupResult)cb;
 ...
 *
 */
-(int) msgsendreport:(rcs_state*)R number:(NSString*)number messageId:(NSString*)messageId reportType:(ReportType)reportType directedType:(DirectedType)directedType callback:(CMessageResult)cb;
 ...
 *
 */
-(int) logout:(rcs_state*)R callback:(CLogoutResult)cb;
 ...
 *
 */
-(int) stop:(rcs_state*)R callback:(CActionResult)cb;
 ...
 *
 */
-(int) msgsendtext:(rcs_state*)R number:(NSString*)number messageId:(NSString*)messageId content:(NSString*)content needReport:(BOOL)needReport isBurn:(BOOL)isBurn directedType:(DirectedType)directedType needReadReport:(BOOL)needReadReport callback:(CMessageResult)cb;
 ...
 *
 */
-(int) msggpsendtext:(rcs_state*)R groupUri:(NSString*)groupUri messageId:(NSString*)messageId content:(NSString*)content needReport:(BOOL)needReport ccNumber:(NSString*)ccNumber callback:(CMessageResult)cb;
 ...
 *
 */
-(int) msggpsendfile:(rcs_state*)R groupUri:(NSString*)groupUri messageId:(NSString*)messageId filePath:(NSString*)filePath contentType:(ContentType)contentType fileName:(NSString*)fileName needReport:(BOOL)needReport start:(int)start thumbnail:(NSString*)thumbnail needReadReport:(BOOL)needReadReport callback:(CMessageResult)cb;
 ...
 *
 */
-(int) doconnect:(rcs_state*)R callback:(CActionResult)cb;
 ...
 *
 */
-(int) msgsendfile:(rcs_state*)R number:(NSString*)number messageId:(NSString*)messageId filePath:(NSString*)filePath contentType:(ContentType)contentType fileName:(NSString*)fileName needReport:(BOOL)needReport start:(int)start thumbnail:(NSString*)thumbnail isBurn:(BOOL)isBurn directedType:(DirectedType)directedType needReadReport:(BOOL)needReadReport callback:(CMessageResult)cb;
