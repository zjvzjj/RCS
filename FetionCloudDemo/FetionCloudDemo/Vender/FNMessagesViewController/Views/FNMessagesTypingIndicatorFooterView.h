...
/**
 *  A constant defining the default height of a `FNMessagesTypingIndicatorFooterView`.
 */
FOUNDATION_EXPORT const CGFloat kFNMessagesTypingIndicatorFooterViewHeight;

/**
 *  The `FNMessagesTypingIndicatorFooterView` class implements a reusable view that can be placed
 *  at the bottom of a `FNMessagesCollectionView`. This view represents a typing indicator 
 *  for incoming messages.
 */
@interface FNMessagesTypingIndicatorFooterView : UICollectionReusableView
