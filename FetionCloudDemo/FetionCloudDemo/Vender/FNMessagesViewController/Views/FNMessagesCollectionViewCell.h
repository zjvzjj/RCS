...
/**
 *  The `FNMessagesCollectionViewCellDelegate` protocol defines methods that allow you to manage
 *  additional interactions within the collection view cell.
 */
@protocol FNMessagesCollectionViewCellDelegate <NSObject>
...
/**
 *  The `FNMessagesCollectionViewCell` is an abstract base class that presents the content for 
 ...
 */
@interface FNMessagesCollectionViewCell : UICollectionViewCell<LinkOpening>

/**
 *  The object that acts as the delegate for the cell.
 */
@property (weak, nonatomic) id<FNMessagesCollectionViewCellDelegate> delegate;

/**
 *  Returns the label that is pinned to the top of the cell.
 *  This label is most commonly used to display message timestamps.
 */
@property (weak, nonatomic, readonly) FNMessagesLabel *cellTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) FNMessagesLabel *messageBubbleTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) FNMessagesLabel *cellBottomLabel;
 ...
 */
@property (weak, nonatomic, readonly) FNMessagesCellTextView *textView;
...
@property (weak, nonatomic, readonly) UIImageView *cancleImageView;

@property (weak, nonatomic, readonly) UIView *cancleContainerView;
