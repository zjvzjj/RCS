...
static NSString * const kFNSystemSoundPlayerUserDefaultsKey = @"kFNSystemSoundPlayerUserDefaultsKey";

NSString * const kFNSystemSoundTypeCAF = @"caf";
NSString * const kFNSystemSoundTypeAIF = @"aif";
NSString * const kFNSystemSoundTypeAIFF = @"aiff";
NSString * const kFNSystemSoundTypeWAV = @"wav";

@interface FNSystemSoundPlayer ()
...
- (void)playSoundWithName:(NSString *)filename
          ...
          completionBlock:(FNSystemSoundPlayerCompletionBlock)completionBlock;
...
- (FNSystemSoundPlayerCompletionBlock)completionBlockForSoundID:(SystemSoundID)soundID;
- (void)addCompletionBlock:(FNSystemSoundPlayerCompletionBlock)block
...
{
    FNSystemSoundPlayer *player = [FNSystemSoundPlayer sharedPlayer];
    
    FNSystemSoundPlayerCompletionBlock block = [player completionBlockForSoundID:soundID];
    if(block) {
        block();
...
@implementation FNSystemSoundPlayer

#pragma mark - Init

+ (FNSystemSoundPlayer *)sharedPlayer
{
    static FNSystemSoundPlayer *sharedPlayer;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedPlayer = [[FNSystemSoundPlayer alloc] init];
    });
...
- (BOOL)readSoundPlayerOnFromUserDefaults
{
    NSNumber *setting = [[NSUserDefaults standardUserDefaults] objectForKey:kFNSystemSoundPlayerUserDefaultsKey];
...
- (void)toggleSoundPlayerOn:(BOOL)on
{
    ...
    [userDefaults setObject:[NSNumber numberWithBool:on] forKey:kFNSystemSoundPlayerUserDefaultsKey];
...
- (SystemSoundID)createSoundIDWithName:(NSString *)filename
                             extension:(NSString *)extension
{
    NSURL *fileURL = [FNSounds urlWithName:filename ext:extension];
