...
//
//  Documentation
//  http://cocoadocs.org/docsets/FNSystemSoundPlayer
//
//
//  GitHub
//  https://github.com/jessesquires/FNSystemSoundPlayer
//
//
//  License
 ...
 */
FOUNDATION_EXPORT NSString * const kFNSystemSoundTypeCAF;

/**
 *  String constant for .aif audio file extension.
 */
FOUNDATION_EXPORT NSString * const kFNSystemSoundTypeAIF;

/**
 *  String constant for .aiff audio file extension.
 */
FOUNDATION_EXPORT NSString * const kFNSystemSoundTypeAIFF;

/**
 *  String constant for .wav audio file extension.
 */
FOUNDATION_EXPORT NSString * const kFNSystemSoundTypeWAV;

/**
 *  A completion block to be called after a system sound has finished playing.
 */
typedef void(^FNSystemSoundPlayerCompletionBlock)(void);

/**
 *  The `FNSystemSoundPlayer` class enables you to play sound effects, alert sounds, or other short sounds.
 ...
 */
@interface FNSystemSoundPlayer : NSObject
...
/**
 *  Returns the shared `FNSystemSoundPlayer` object. This method always returns the same sound system player object.
 *
 *  @return An initialized `FNSystemSoundPlayer` object if successful, `nil` otherwise.
 */
+ (FNSystemSoundPlayer *)sharedPlayer;

/**
 *  Toggles the sound player on or off by setting the `kFNSystemSoundPlayerUserDefaultsKey` key in `NSUserDefaults` to the given value.
 *  This will enable or disable the playing of sounds via `FNSystemSoundPlayer` globally.
 ...
 *  This parameter must be one of `kFNSystemSoundTypeCAF`, `kFNSystemSoundTypeAIF`, `kFNSystemSoundTypeAIFF`, or `kFNSystemSoundTypeWAV`.
 *
 ...
 *  This block is retained by `FNSystemSoundPlayer`, temporarily cached, and released after its execution.
 *
 *  @warning If the system sound object cannot be created, this method does nothing.
 */
- (void)playSoundWithFilename:(NSString *)filename
                fileExtension:(NSString *)fileExtension
                   completion:(FNSystemSoundPlayerCompletionBlock)completionBlock;
