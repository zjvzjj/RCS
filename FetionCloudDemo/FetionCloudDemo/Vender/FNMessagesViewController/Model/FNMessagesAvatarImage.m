...
@implementation FNMessagesAvatarImage 
...
+ (instancetype)avatarWithImage:(UIImage *)image
{
    ...
    return [[FNMessagesAvatarImage alloc] initWithAvatarImage:image
...
{
    return [[FNMessagesAvatarImage alloc] initWithAvatarImage:nil
