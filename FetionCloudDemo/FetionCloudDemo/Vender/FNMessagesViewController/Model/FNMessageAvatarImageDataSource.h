...
/**
 *  The `FNMessageAvatarImageDataSource` protocol defines the common interface through which
 *  a `FNMessagesViewController` and `FNMessagesCollectionView` interact with avatar image model objects.
 *
 ...
 *
 *  A concrete class that conforms to this protocol is provided in the library. See `FNMessagesAvatarImage`.
 *
 *  @see FNMessagesAvatarImage.
 */
@protocol FNMessageAvatarImageDataSource <NSObject>
