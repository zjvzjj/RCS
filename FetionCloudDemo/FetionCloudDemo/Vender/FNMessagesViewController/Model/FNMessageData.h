...
/**
 *  The `FNMessageData` protocol defines the common interface through which 
 *  a `FNMessagesViewController` and `FNMessagesCollectionView` interact with message model objects.
 *
 ...
 *
 *  Two concrete classes that conform to this protocol are provided in the library. See `FNTextMessage` and `FNMediaMessage`.
 *
 *  @see FNMessage.
 *  @see FNTextMessage.
 *  @see FNMediaMessage.
 */
@protocol FNMessageData <NSObject>
 ...
 *  If this method returns `YES`, an instance of `FNMessagesViewController` will ignore 
 *  the `text` method of this protocol when dequeuing a `FNMessagesCollectionViewCell`
