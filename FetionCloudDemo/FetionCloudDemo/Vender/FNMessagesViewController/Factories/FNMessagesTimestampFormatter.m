...
@interface FNMessagesTimestampFormatter ()
...
@implementation FNMessagesTimestampFormatter

#pragma mark - Initialization

+ (FNMessagesTimestampFormatter *)sharedFormatter
{
    static FNMessagesTimestampFormatter *_sharedFormatter = nil;
    
    static dispatch_once_t onceToken = 0;
    dispatch_once(&onceToken, ^{
        _sharedFormatter = [[FNMessagesTimestampFormatter alloc] init];
    });
