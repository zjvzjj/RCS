...
/**
 *  An instance of `FNMessagesTimestampFormatter` is a singleton object that provides an efficient means 
 *  for creating attributed and non-attributed string representations of `NSDate` objects. 
 *  It is intended to be used as the method by which you display timestamps in a `FNMessagesCollectionView`.
 */
@interface FNMessagesTimestampFormatter : NSObject

/**
 *  Returns the cached date formatter object used by the `FNMessagesTimestampFormatter` shared instance.
 */
 ...
 */
+ (FNMessagesTimestampFormatter *)sharedFormatter;
