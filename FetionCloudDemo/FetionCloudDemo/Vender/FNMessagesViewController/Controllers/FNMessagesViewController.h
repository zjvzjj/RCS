...
/**
 *  The `FNMessagesViewController` class is an abstract class that represents a view controller whose content consists of
 *  a `FNMessagesCollectionView` and `FNMessagesInputToolbar` and is specialized to display a messaging interface.
 *
 *  @warning This class is intended to be subclassed. You should not use it directly.
 */
@interface FNMessagesViewController : UIViewController <FNMessagesCollectionViewDataSource,
                                                         FNMessagesCollectionViewDelegateFlowLayout,
                                                         UITextViewDelegate>
 ...
 */
@property (weak, nonatomic, readonly) FNMessagesCollectionView *collectionView;

/**
 *  The display name of the current user who is sending messages.
 *  This value does not have to be unique.
 *
 *  @discussion This value must not be `nil`. The default value is `@"FNDefaultSender"`.
 */
 ...
 *  This value must not be `nil`. The default value is `@"FNDefaultSender"`.
 */
 ...
 *  The default value is the string returned by `[FNMessagesCollectionViewCellOutgoing cellReuseIdentifier]`.
 ...
 *  The default value is the string returned by `[FNMessagesCollectionViewCellOutgoing mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see FNMessagesCollectionViewCellOutgoing.
 *
 ...
 *  The default value is the string returned by `[FNMessagesCollectionViewCellIncoming cellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 ...
 *  The default value is the string returned by `[FNMessagesCollectionViewCellIncoming mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see FNMessagesCollectionViewCellIncoming.
 *
...
/**
 *  Returns the `UINib` object initialized for a `FNMessagesViewController`.
 *
...
/**
 *  Creates and returns a new `FNMessagesViewController` object.
 *  
 *  @discussion This is the designated initializer for programmatic instantiation.
 *
 *  @return An initialized `FNMessagesViewController` object if successful, `nil` otherwise.
 */
