...
/**
 *  A constant that describes the default height for all label subviews in a `FNMessagesCollectionViewCell`.
 *
 *  @see FNMessagesCollectionViewCell.
 */
FOUNDATION_EXPORT const CGFloat kFNMessagesCollectionViewCellLabelHeightDefault;

/**
 *  A constant that describes the default size for avatar images in a `FNMessagesCollectionViewFlowLayout`.
 */
FOUNDATION_EXPORT const CGFloat kFNMessagesCollectionViewAvatarSizeDefault;



/**
 *  The `FNMessagesCollectionViewFlowLayout` is a concrete layout object that inherits 
 *  from `UICollectionViewFlowLayout` and organizes message items in a vertical list.
 *  Each `FNMessagesCollectionViewCell` in the layout can display messages of arbitrary sizes and avatar images, 
 ...
 *  defined in `FNMessagesCollectionViewDelegateFlowLayout`.
 *
 *  @see FNMessagesCollectionViewDelegateFlowLayout.
 *  @see FNMessagesCollectionViewCell.
 */
@interface FNMessagesCollectionViewFlowLayout : UICollectionViewFlowLayout

/**
 *  The collection view object currently using this layout object.
 */
@property (readonly, nonatomic) FNMessagesCollectionView *collectionView;
 ...
 *  in your `FNMessagesViewController` subclass.
 *
 ...
 *  `FNMessagesCollectionViewCell` in the collectionView. 
 *  
...
/**
 *  The horizontal spacing used to lay out the `messageBubbleContainerView` frame within each `FNMessagesCollectionViewCell`.
...
/**
 *  The inset of the frame of the text view within the `messageBubbleContainerView` of each `FNMessagesCollectionViewCell`.
...
/**
 *  The inset of the text container's layout area within the text view's content area in each `FNMessagesCollectionViewCell`. 
 ...
 *  You may use `kFNMessagesCollectionViewAvatarSizeDefault` to size your avatars to the default value.
 */
...
@property (assign, nonatomic) CGSize cancleIamgeViewSize;
...
/**
 *  Computes and returns the size of the `messageBubbleImageView` property of a `FNMessagesCollectionViewCell`
